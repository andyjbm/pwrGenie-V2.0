...
#define ESP_ASYNC_WIFIMANAGER_VERSION           "ESPAsync_WiFiManager v2.0.0"

#define ESP_ASYNC_WIFIMANAGER_VERSION_MAJOR     2
#define ESP_ASYNC_WIFIMANAGER_VERSION_MINOR     0
#define ESP_ASYNC_WIFIMANAGER_VERSION_PATCH     0

#define ESP_ASYNC_WIFIMANAGER_VERSION_INT       2000000
...
/*
    ...
    std::vector<const char *> _menuIdsParams  = {"param","wifi","info","exit","sep","debug","update","restart"};
